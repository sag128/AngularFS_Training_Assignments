...
@Component({
  selector: 'app-emp-range',
  templateUrl: './emp-range.component.html',
  styleUrls: ['./emp-range.component.scss']
})
export class EmpRangeComponent implements OnInit {
  ...
  employeeHeaders:string[] = Object.keys(this.employeeData[0]);

  min:number=10000;
  max:number=20000;
  filterMin:number=10000;
  filterMax:number=20000;
